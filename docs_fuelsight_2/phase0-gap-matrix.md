...
| features/data-import.md | `/import` | implemented | `backend/app/api/v1/imports.py`, `backend/app/schemas/imports.py`, `frontend/src/pages/ImportPage.tsx`, `frontend/src/features/import/components/ImportUploadCard.tsx`, `frontend/src/features/import/components/ImportJobsTable.tsx` | `backend/tests/test_import_api.py`, `frontend/src/pages/ImportPage.integration.test.tsx`, `frontend/src/features/import/components/ImportUploadCard.test.tsx` | admin uploads CSV/XLSX by drag-and-drop or file picker, refreshes initial history and opens diagnostics | keep as-built docs synced with neutral copy, admin-only diagnostics and upload limits |
| screens/screen-data-import.md | `/import` | implemented | `frontend/src/pages/ImportPage.tsx`, `frontend/src/features/import/components/ImportUploadCard.tsx`, `frontend/src/components/common/DiagnosticsDrawer.tsx` | `frontend/src/pages/ImportPage.integration.test.tsx`, `frontend/src/features/import/components/ImportUploadCard.test.tsx`, `frontend/e2e/admin-operational-flow.spec.ts` | admin operational flow with drag-and-drop upload | keep tablet/mobile admin view smoke current |
...
| screens/screen-kpi-dashboard.md | `/dashboard` | implemented | `frontend/src/pages/DashboardPage.tsx`, `frontend/src/features/kpi/components/DemandSnapshotChart.tsx`, `frontend/src/lib/charts/chartOptions.ts`, `frontend/src/app/layout/AppShell.tsx` | `frontend/src/pages/DashboardPage.states.test.tsx`, `frontend/src/features/kpi/components/DemandSnapshotChart.test.tsx`, `frontend/src/lib/charts/chartOptions.test.ts`, `corepack pnpm --filter frontend test:e2e:mobile` | commission sees KPI summary and badges on phone width without layout breakage | keep shared chart helper and badge/degraded state tests current |
...
| screens/screen-news-digest-chat.md | `/news` | implemented | `frontend/src/pages/NewsPage.tsx`, `frontend/src/features/news/components/ChatThread.tsx`, `frontend/src/features/news/components/NewsSearchDrawer.tsx`, `frontend/e2e/mobile-smoke.spec.ts` | `frontend/src/pages/NewsPage.llmStatus.test.tsx`, `frontend/src/features/news/components/ChatThread.test.tsx`, `frontend/src/features/news/components/NewsDigestPanel.test.tsx`, `frontend/src/features/news/components/NewsSearchDrawer.test.tsx`, `corepack pnpm --filter frontend test:e2e:mobile` | commission sees digest, citations and page-level provider badges in mobile tabs and desktop sticky chat layout | keep retrieval-mode UX aligned with page-level health badges and mobile tab contract |
