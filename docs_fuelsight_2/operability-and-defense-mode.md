...
## Цель
FuelSight v2 должен выглядеть как управляемый внутренний продукт, а не как набор разрозненных страниц. Для этого нужен режим защиты, который воспроизводимо поднимает данные, модель, новости и проверки состояния.
