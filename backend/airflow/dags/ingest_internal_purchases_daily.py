...
@dag(
    dag_id="ingest_internal_purchases_daily",
    schedule="30 1 * * *",
...
def ingest_internal_purchases_daily_dag():
    ...
    def ingest_files(_: dict[str, str]) -> dict:
        return run_pipeline_command("ingest-purchases-daily")

    ingest_files(heartbeat())


dag_instance = ingest_internal_purchases_daily_dag()
